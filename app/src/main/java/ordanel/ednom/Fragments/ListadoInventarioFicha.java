 ...
 */
public class ListadoInventarioFicha extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                setListAdapter( new InstrumentoArrayAdapter( getActivity().getApplicationContext(), instrumentoBL.listadoInventarioFicha(nro_aula, 0, PAGESIZE) ) );
                ...
                getListView().setOnScrollListener(new AbsListView.OnScrollListener() {
                    ...
                    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                        ...
                        if (!loading && lastItem && moreRows) {
                            loading = true;
                            getListView().addFooterView(footerView, null, false);
                            (new ListadoInventarioFichaAsync()).execute( nro_aula, getListAdapter().getCount(), PAGESIZE );
                        }
    ...
    private class ListadoInventarioFichaAsync extends AsyncTask<Integer, Void, String> {
        ...
        protected String doInBackground(Integer... params) {
            ...
            newData = instrumentoBL.listadoInventarioFicha(nro_aula, offset, limit);
